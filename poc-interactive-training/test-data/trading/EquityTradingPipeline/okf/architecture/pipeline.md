...
description: The ordered stage sequence every equity order flows through and how latency is measured.
...
agnostic; the equity-specific behaviour lives entirely in the injected stages.

# Stage sequence

1. **validate** — `EquityOrderValidator`
2. **route** — `Rule606OrderRouter`
3. **execute** — `FifoTaxLotAllocator`
4. **settle** — `EquityClearingService`
