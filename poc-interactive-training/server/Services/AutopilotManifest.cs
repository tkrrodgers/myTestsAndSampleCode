...
public static class AutopilotManifest
{
    ...
    [
        ...
        // ---- 19 cobol-domains ------------------------------------------------
        S("dom.01", "cobol-domains", 19, AutoKind.Scroll, selector: "[data-auto='dom.coverage']",
        ...
        S("dom.01b", "cobol-domains", 19, AutoKind.Scroll, selector: "[data-auto='dom.jcl']",
        ...
        S("dom.02", "cobol-domains", 19, AutoKind.Click, selector: "[data-auto='dom.pdg']",
        ...
        S("dom.03", "cobol-domains", 19, AutoKind.Observe, result: true,
        ...
        S("dom.04", "cobol-domains", 19, AutoKind.Scroll, selector: "[data-auto='dom.fields']",
        ...
        S("dom.04b", "cobol-domains", 19, AutoKind.Scroll, selector: "[data-auto='dom.neurons']",
        ...
        S("dom.05", "cobol-domains", 19, AutoKind.Click, selector: "[data-auto='dom.cortex']",
        ...
        S("dom.06", "cobol-domains", 19, AutoKind.Scroll, selector: "[data-auto='dom.findings']",
        ...
        S("s19.01", "ticket-gate", 20, AutoKind.Observe,
        ...
        S("s19.02", "ticket-gate", 20, AutoKind.Click, selector: "[data-auto='s19.run']", bridge: true,
        ...
        S("s19.03", "ticket-gate", 20, AutoKind.Observe, result: true,
        ...
        // ---- 21 trap-hunt ----------------------------------------------------
        S("s20.01", "trap-hunt", 21, AutoKind.Click, selector: "[data-auto='s20.run']", bridge: true,
        ...
        S("s20.02", "trap-hunt", 21, AutoKind.Observe, result: true,
        ...
        // ---- 22 drift-scorecard ----------------------------------------------
        S("s21.01", "drift-scorecard", 22, AutoKind.Observe,
            ["The golden case is a frozen commit, its ticket, and the patch a human actually wrote."]),
        S("s21.02", "drift-scorecard", 22, AutoKind.Click, selector: "[data-auto='s21.agent']", bridge: true,
        ...
        S("s21.03", "drift-scorecard", 22, AutoKind.Observe, result: true,
            facts: ["The scorecard separates what was executed from what was judged."],
            mustNot: ["that one golden case generalises"]),

        // ---- 23 phase-zero ---------------------------------------------------
        S("s22.01", "phase-zero", 23, AutoKind.Select, selector: "[data-auto='s22.blast']", value: "Customer-facing",
            facts: ["Risk tier is derived from blast radius, autonomy, and data tier together."]),
        S("s22.02", "phase-zero", 23, AutoKind.Select, selector: "[data-auto='s22.autonomy']", value: "Acts-autonomously",
            facts: ["Autonomy is the second axis: suggests, acts with approval, or acts autonomously."]),
        S("s22.03", "phase-zero", 23, AutoKind.Select, selector: "[data-auto='s22.datatier']", value: "Restricted",
            facts: ["Restricted data raises the tier on its own, regardless of the other axes."]),
        S("s22.04", "phase-zero", 23, AutoKind.Click, selector: "[data-auto='s22.tier']",
        ...
        S("s22.05", "phase-zero", 23, AutoKind.Click, selector: "[data-auto='s22.classify']",
        ...
        S("s23.02", "context-curve", 24, AutoKind.Click, selector: "[data-auto='s23.run']", bridge: true,
        ...
        S("s23.03", "context-curve", 24, AutoKind.Observe, result: true,
        ...
        // ---- 25 action-authority ---------------------------------------------
        S("s24.01", "action-authority", 25, AutoKind.Select, selector: "[data-auto='s24.action']", value: "rerun-tests",
            facts: ["Authority is decided per exact action against the agent's registered envelope."]),
        S("s24.02", "action-authority", 25, AutoKind.Click, selector: "[data-auto='s24.decide']",
        ...
        S("s24.03", "action-authority", 25, AutoKind.Select, selector: "[data-auto='s24.action']", value: "deploy-prod",
            facts: ["The same agent now proposes a production deployment."]),
        S("s24.04", "action-authority", 25, AutoKind.Click, selector: "[data-auto='s24.decide']",
            wait: AutoWait.Element, waitKey: "[data-auto='s24.decision']", timeout: 15, result: true,
        ...
        // ---- 26 framing-lab ---------------------------------------------------
        S("s25.01", "framing-lab", 26, AutoKind.Observe,
            ["One question is asked three ways of one model: neutral, leading, and authority-framed."]),
        S("s25.02", "framing-lab", 26, AutoKind.Click, selector: "[data-auto='s25.run']", bridge: true,
        ...
        S("s25.03", "framing-lab", 26, AutoKind.Observe, result: true,
        ...
        // ---- 27 regression-adequacy -------------------------------------------
        S("s26.01", "regression-adequacy", 27, AutoKind.Observe,
        ...
        S("s26.02", "regression-adequacy", 27, AutoKind.Observe,
        ...
        S("s26.03", "regression-adequacy", 27, AutoKind.Scroll, selector: "[data-auto='s26.vectors']",
        ...
        S("s26.04", "regression-adequacy", 27, AutoKind.Click, selector: "[data-auto='s26.mutate']",
        ...
        S("s26.05", "regression-adequacy", 27, AutoKind.Observe, result: true,
        ...
        S("s26.06", "regression-adequacy", 27, AutoKind.Observe, result: true,
        ...
        S("s26.07", "regression-adequacy", 27, AutoKind.Observe, result: true,
        ...
        S("s26.08", "regression-adequacy", 27, AutoKind.Click, selector: "[data-auto='s26.guidance']", bridge: true,
        ...
        // ---- 28 ephemeral-test -------------------------------------------------
        S("s27.01", "ephemeral-test", 28, AutoKind.Observe,
        ...
        S("s27.02", "ephemeral-test", 28, AutoKind.Click, selector: "[data-auto='s27.run']", bridge: true,
        ...
        S("s27.03", "ephemeral-test", 28, AutoKind.Observe, result: true,
            facts: ["Not checked in is not the same as not sent.",
                    "The audit record keeps references rather than payloads."]),

        // ---- 29 portfolio-tiers -------------------------------------------------
        S("s28.01", "portfolio-tiers", 29, AutoKind.Click, selector: "[data-auto='s28.load']",
        ...
        S("s28.02", "portfolio-tiers", 29, AutoKind.Click, selector: "[data-auto='s28.amp-APM-1042']",
            facts: ["Tier two is the APM record, which bounds what a team actually owns."]),
        S("s28.03", "portfolio-tiers", 29, AutoKind.Click, selector: "[data-auto='s28.amp-APM-1187']",
        ...
        S("s28.04", "portfolio-tiers", 29, AutoKind.Click, selector: "[data-auto='s28.tiers']", bridge: true,
        ...
        S("s28.05", "portfolio-tiers", 29, AutoKind.Observe, result: true,
        ...
        // ---- 30 common-code ------------------------------------------------------
        S("s29.01", "common-code", 30, AutoKind.Click, selector: "[data-auto='s29.analyse']",
        ...
        S("s29.02", "common-code", 30, AutoKind.Observe,
        ...
        S("s29.03", "common-code", 30, AutoKind.Click, selector: "[data-auto='s29.consolidate']", bridge: true,
        ...
        S("s29.04", "common-code", 30, AutoKind.Observe, result: true,
        ...
        // ---- 31 token-economics ---------------------------------------------------
        S("s30.01", "token-economics", 31, AutoKind.Click, selector: "[data-auto='s30.run']",
        ...
        S("s30.02", "token-economics", 31, AutoKind.Observe,
        ...
        // ---- 32 pattern-library ----------------------------------------------------
        S("s31.01", "pattern-library", 32, AutoKind.Observe,
            ["The submission in the box is a pre-filled worked example."]),
        S("s31.02", "pattern-library", 32, AutoKind.Click, selector: "[data-auto='s31.submit']", bridge: true,
        ...
        S("s31.03", "pattern-library", 32, AutoKind.Observe, result: true,
        ...
        // ---- 33 plan-first ------------------------------------------------------------
        S("s32.01", "plan-first", 33, AutoKind.Click, selector: "[data-auto='s32.review']",
        ...
        S("s32.02", "plan-first", 33, AutoKind.Observe,
            ["Jumping straight to an implementation is the habit this gate exists to break."]),

        // ---- 34 leadership-map ---------------------------------------------------------
        S("s33.01", "leadership-map", 34, AutoKind.Observe,
        ...
        S("s33.02", "leadership-map", 34, AutoKind.Observe,
            ["The auto-run does not follow these links, because every scene has already been run."]),

        // ---- 35 crypto-sme --------------------------------------------------------------
        S("s34.01", "crypto-sme", 35, AutoKind.Observe,
            ["The ticket is a spot crypto execution adapter against a specific venue."]),
        S("s34.02", "crypto-sme", 35, AutoKind.Click, selector: "[data-auto='s34.run']", bridge: true,
        ...
        S("s34.03", "crypto-sme", 35, AutoKind.Observe, result: true,
        ...
        S("s34.04", "crypto-sme", 35, AutoKind.Observe, result: true,
